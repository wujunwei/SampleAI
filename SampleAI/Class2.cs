    ...
    protected override void Act(JObject state)
    {
        ...
        for (int i = 0; i < enemies.Count; i++)
        {
            ...
            else
            {
                ...
                {
                    float x4 = (float)enemy["pos"]["x"];
                    float z4 = (float)enemy["pos"]["z"];
                    UseSkill(0, x4,z4);
                }
            }
        ...
        if (targets.Count() > 0)
        {
            ...
            if (target.Count() > 0)
            {
                float x5 = (float)target[0]["x"];
                float z5 = (float)target[0]["z"];
                UseSkill(0, x5,z5);
            }
